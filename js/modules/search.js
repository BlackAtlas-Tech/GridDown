...
const SearchModule = (function() {
    ...
    const HELP_TOPICS = [
        ...
        { id: 'help-wifisentinel', name: 'WiFi Sentinel', keywords: ['wifi', 'sentinel', 'drone', 'detection', 'uav', 'uas', 'dji', 'parrot', 'skydio', 'autel', 'yuneec', 'deauth', 'fingerprint', 'oui', 'bssid', 'esp32', 'termux'], icon: '📶', description: 'Passive drone detection via WiFi fingerprinting', content: 'Detect drones by fingerprinting WiFi beacons and probes against known manufacturer signatures. Supports DJI, Parrot, Skydio, Autel, Yuneec, Hubsan, FIMI, Ryze/Tello, and SkyViper. Dual-tier: ESP32-C5 hardware for full detection or Termux WiFi scan bridge for beacon-only monitoring without ESP32.', panel: 'wifisentinel' },
